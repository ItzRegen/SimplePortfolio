...
<html lang="sk">
  ...
  <body class="bg-dark text-white">
      ...
      <div class="container col-9 col-md-12">
        ...
        <form class="mx-auto" style="max-width: 500px" id="kontaktForm">
          ...
          <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="gdprCheck" required>
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-warning px-4">Odoslať</button>
          </div>
        </form>
      </div>
    </section>
    ...
    <!-- Kontakt -->
    <div class="container d-flex flex-column flex-md-row justify-content-between py-3 col-12 col-md-6">
        <p class="mb-1">
            Kontaktný mail: <a href="mailto:info@mojadomena.sk" class="text-warning">adrian.ciffary@gmail.com</a>
        </p>
        <p>
            Telefónne číslo: <a href="tel:+421948005764" class="text-warning">+421 948 005 764</a>
        </p>
    </div>
